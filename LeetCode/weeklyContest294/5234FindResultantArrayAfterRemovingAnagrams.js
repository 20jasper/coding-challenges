...
//SOLUTION--
/* I am going to iterate through the array and check if the next number is an anagram of the last, 
    if so, remove the first from the array
...
const removeAnagrams = function (words) {
    for (let i = 0; i < words.length - 1; i++) {
        ...
        if (sortCharacters(currentWord) === sortCharacters(nextWord)) {
            words.splice(i + 1, 1)
            i--
        }
    }
