//URL--
// https://www.codewars.com/kata/583872e3c233416868000162
...
//SOLUTION--
/* I will return an array of the three lowest numbers in each array
    I will use Math.min and the spread operator to find the smallest item in each array 
    Then I will put each smallest number in an array
*/
function lowest(a, b, c) {
    return [Math.min(...a), Math.min(...b), Math.min(...c),]
}
//TESTCASES--
console.log(lowest([15, 14, 13, 12, 10], [16, 17, 12, 9, 11], [18, 16, 15, 14, 12]), [10, 9, 12]);